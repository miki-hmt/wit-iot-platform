...
public class MyGenerator {
		...
		public static final String URL = "jdbc:mysql://127.0.0.1:3306/dolphinscheduler?useSSL=false&serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf8";
		public static final String NAME = "root";
		public static final String PASS = "root";
		//public static final String DATABASE = "foundation_item";
		public static final String DATABASE = "dolphinscheduler";
		// 类信息：类名、对象名（一般是【类名】的首字母小些）、类说明、时间
		public static final String CLASSNAME = "foreign";
		//public static final String TABLE = "item";
		public static final String TABLE = "t_ds_subject_sets";
