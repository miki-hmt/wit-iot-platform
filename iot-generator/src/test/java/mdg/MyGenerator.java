...
public class MyGenerator {
		...
		public static final String URL = "jdbc:mysql://127.0.0.1:3307/wittest?useSSL=false&serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf8";
		public static final String NAME = "root";
		public static final String PASS = "root";
		public static final String DATABASE = "wittest";
		// 类信息：类名、对象名（一般是【类名】的首字母小些）、类说明、时间
		public static final String CLASSNAME = "foreign";
		public static final String TABLE = "bs_work";
		public static final String CLASSCOMMENT = "API应用KEY";
		public static final String TIME = "2019年10月16日";
		public static final String AGILE = new Date().getTime() + "";
		// 路径信息，分开路径方便聚合工程项目，微服务项目
		public static final String ENTITY_URL = "com.wit.iot.device.domain";
		public static final String DAO_URL = "com.wit.iot.device.mapper";
		public static final String XML_URL = "com.wit.iot.device.mapper.xml";
		public static final String SERVICE_URL = "com.wit.iot.device.service";
		public static final String SERVICE_IMPL_URL = "com.wit.iot.device.service.impl";
		public static final String CONTROLLER_URL = "com.wit.iot.device.web";
		//是否是Swagger配置
